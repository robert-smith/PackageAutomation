function New-PAIntuneWin32AppRequirementRuleRegistry {
    <#
    .SYNOPSIS
        Create a new registry type of Requirement rule object to be used for the Add-PAIntuneWin32App function.
