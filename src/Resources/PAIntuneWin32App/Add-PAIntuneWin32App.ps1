function Add-PAIntuneWin32App {
    ...
    Process {
        try {
            ...
            $IntuneWinXMLMetaData = Get-PAIntuneWin32AppMetaData -FilePath $FilePath -ErrorAction Stop
            ...
            if ($IntuneWinXMLMetaData -ne $null) {
                ...
                switch ($PSCmdlet.ParameterSetName) {
                    "MSI" {
                        ...
                        $Win32AppBody = New-PAIntuneWin32AppBody @AppBodySplat
                ...
                $DefaultReturnCodes = Get-PAIntuneWin32AppDefaultReturnCode
                ...
                if ($Win32MobileAppRequest.'@odata.type' -notlike "#microsoft.graph.win32LobApp") {
                    ...
                    if ([string]::IsNullOrEmpty($Win32MobileAppContentVersionRequest.id)) {
                        ...
                        $IntuneWinFilePath = Expand-PAIntuneWin32AppCompressedFile -FilePath $FilePath -FileName $IntuneWinXMLMetaData.ApplicationInfo.FileName -FolderName "Expand"
                        if ($IntuneWinFilePath -ne $null) {
                            ...
                            if ([string]::IsNullOrEmpty($Win32MobileAppFileContentRequest.id)) {
                                ...
                                $ContentVersionsFiles = Wait-PAIntuneWin32AppFileProcessing -Stage "AzureStorageUriRequest" -Resource $FilesUri
                                ...
                                $CommitFileRequest = Wait-PAIntuneWin32AppFileProcessing -Stage "CommitFile" -Resource $FilesUri
