function Get-PAIntuneWin32AppAssignment {
    <#
    .SYNOPSIS
            ...
            "Group" {
                foreach ($Win32MobileApp in $Win32MobileAppsList) {
                    try {
                        ...
                        Write-Error -Message "An error occurred while retrieving Win32 app assignments for app with ID: $($Win32MobileApp.id). Error message: $($_.Exception.Message)"
                    }
                }
            }
            default {
