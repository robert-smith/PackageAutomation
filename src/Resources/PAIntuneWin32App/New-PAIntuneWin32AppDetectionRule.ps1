function New-PAIntuneWin32AppDetectionRule {
    <#
    .SYNOPSIS
        Construct a new detection rule required for Add-PAIntuneWin32App cmdlet.
    ...
    Write-Warning -Message "- New-PAIntuneWin32AppDetectionRuleFile"
    Write-Warning -Message "- New-PAIntuneWin32AppDetectionRuleMSI"
    Write-Warning -Message "- New-PAIntuneWin32AppDetectionRuleRegistry"
    Write-Warning -Message "- New-PAIntuneWin32AppDetectionRuleScript"
