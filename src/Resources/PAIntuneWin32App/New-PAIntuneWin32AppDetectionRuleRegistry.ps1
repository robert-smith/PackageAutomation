function New-PAIntuneWin32AppDetectionRuleRegistry {
    <#
    .SYNOPSIS
        Create a new registry type of detection rule object to be used for the Add-PAIntuneWin32App function.
