function Add-PAIntuneWin32AppAssignment {
    <#
    .SYNOPSIS
    ...
    Begin {
        ...
        Write-Warning -Message "- Add-PAIntuneWin32AppAssignmentAllDevices"
        Write-Warning -Message "- Add-PAIntuneWin32AppAssignmentAllUsers"
        Write-Warning -Message "- Add-PAIntuneWin32AppAssignmentGroup"
