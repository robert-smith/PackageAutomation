function New-PAIntuneWin32AppRequirementRuleScript {
    <#
    .SYNOPSIS
        Create a new script type of Requirement rule object to be used for the Add-PAIntuneWin32App function.
