...
# Customized IntuneWin32App functions
$PAIntuneWin32App = @( Get-ChildItem -Path $PSScriptRoot\Resources\PAIntuneWin32App\*.ps1 -ErrorAction SilentlyContinue)

Foreach($import in @($Public + $Private + $PAIntuneWin32App))
{
    Try
    {
        . $import.fullname
